...
<main>
	...
	<div class="sub subList3">
		<ul>
			<li class="on"><a href="/upper/anatomy/backA">등</a></li>
	...
	<div class="selectedList">
		...
		<ul>
			...
			<ul class="pagination">
				...
				<li class="page-item"><a class="page-link" href="/findAll.jsp?currentPage=${pno}">${pno}</a></li>
				</c:forEach>
				<c:if test="${pagelist.endPage<pagelist.totalPage }">
				<li class="page-item"><a class="page-link" href="/findAll.jsp?currentPage=${pagelist.startPage+5}">다음</a></li>
				</c:if>
			</ul>	
