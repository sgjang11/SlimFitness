...
<main>
	<div class="sub subList2">
		<ul>
			...
			<li class="on"><a href="/upper/exercise/backE">Exercise</a></li>
			<li><a href="/upper/taping/backT">Taping</a></li>
		</ul>
	</div>
	<div class="sub subList3">
		<ul>
			<li><a href="/upper/exercise/backE">등</a></li>
			<li><a href="/upper/exercise/chestE">가슴</a></li>
			<li class="on"><a href="/upper/exercise/shoulderE">어깨</a></li>
			<li><a href="/upper/exercise/abdomenE">복부</a></li>
			<li><a href="/upper/exercise/armE">팔</a></li>		
		</ul>
	</div>
	<div class="searching">
	...
	<div>
		...
		<ul>
			...
			<ul class="pagination">
				...
				<li class="page-item"><a class="page-link" href="/upper/exercise/shoulderE?currentPage=${pagelist.startPage-5}">이전</a></li>
				</c:if>
				<c:forEach var="pno"  begin="${pagelist.startPage}" end="${pagelist.endPage}" step="1">
				<li class="page-item"><a class="page-link" href="/upper/exercise/shoulderE?currentPage=${pno}">${pno}</a></li>
				</c:forEach>
				<c:if test="${pagelist.endPage<pagelist.totalPage }">
				<li class="page-item"><a class="page-link" href="/upper/exercise/shoulderE?currentPage=${pagelist.startPage+5}">다음</a></li>
				</c:if>
			</ul>	
