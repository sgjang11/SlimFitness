...
//	isdel number(1) check(isdel in(0,1))
	...
	public UpperBoardVO(String kind, int idx, String title, String content, Date writeDay, String fileName1,
	...
	public UpperBoardVO(String title, String content, String fileName1,
